...
ActiveRecord::Schema.define(version: 2021_03_15_130755) do
  ...
  create_table "choice_counts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["post_id"], name: "index_choice_counts_on_post_id"
    t.index ["user_id"], name: "index_choice_counts_on_user_id"
  end
  ...
  add_foreign_key "choice_counts", "posts"
  add_foreign_key "choice_counts", "users"
